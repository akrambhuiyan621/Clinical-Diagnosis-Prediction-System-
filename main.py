...
# ডাটাবেস টেবিল এবং ডিফল্ট অ্যাডমিন তৈরি করার ফাংশন
def init_db():
    db = get_db()
    ...
    # চেক করা অ্যাডমিন আছে কি না, না থাকলে তৈরি করা
...
# অ্যাপ চালু হওয়ার সময় ডাটাবেস চেক করবে
init_db()
...
def admin_dashboard():
    if "user" in session and session["user"] == "admin":
        db = get_db()
        # আইডি সিরিয়াল অনুযায়ী সবাই থাকবে
